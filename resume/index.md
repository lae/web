...
- wrote an internal tool in Rust to make it easier for my team to manage servers<br /><br />
...
- wrote several ansible roles of good quality (subjective in a sense - but
  check out the Github link), many of which are open sourced<br /><br />
...
- was responsible for the security audit after the Heartbleed PSA<br /><br />
...
- wrote [public announcements](http://forums.hostgator.com/search.php?do=finduser&u=126179)
  ...
  for extended downtime issues.  <br /><br />
...
- Filed internal bug reports and wrote documentation for company wikis and knowledgebase.<br /><br />

### Contracted Roles

* [**batee.com**](http://batee.com) - redesigned website using Bootstrap; moved
  editing process from disparate HTML files to Jekyll static site generation<br /><br />
...
* [**The Bike Project of Urbana-Champaign**](http://thebikeproject.org)
  ...
  old laptops with Debian for use at the shop.  <br /><br />
...
* [**SIF Tracker**](https://github.com/lae/sift) - per-user leaderboard tracking
  web application written in bottle.py/Flask, with some backend bits in Ruby  <br /><br />
